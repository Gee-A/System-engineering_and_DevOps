...
Scripting | [4-TCP_and_UDP_ports](./4-TCP_and_UDP_ports) | displays listening ports that only shows listening sockets and shows the PID and name of the program to which each socket belong
scripting | [5-is_the_host_on_the_network](./5-is_the_host_on_the_network) | bash script pings an IP address passed as an argument 5 times
